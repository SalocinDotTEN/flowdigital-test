    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="mailing_address" class="block mt-1 w-full" type="text" name="mailing_address"
                    required />
            </div>
            ...
            <div>
                ...
                <select name="mailing_addr_country" id="mailing_addr_country" class="block mt-1 w-full text-white appearance-none"
                    ...
                    @foreach (LaravelCountries::getCountries()->getData() as $country)
                        <option value="{{ $country->iso2 }}" {{ $country->iso2 == "MY" ? "selected" : ""}}>{{ $country->name }}</option>
                    @endforeach
                </select>
            </div>
